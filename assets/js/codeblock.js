...
const CodeBlock = {
    ...
    initCodeBlockOverflowY:function(overflowHeight,overflowY){
        ...
        eles.forEach(function(ele, index, eles) {
            ...
            if(ele.offsetHeight > overflowHeight){
                ...
                showMoreDiv.innerHTML = '<i class="fa-solid fa-angles-down fa-beat-fade" style="font-size:16px;">点击展开</i>';
                ...
                showMoreDiv.addEventListener('click', function(){
                    if(showMoreDiv.innerHTML.indexOf('fa-angles-down') >= 0 ){
                        ...
                        showMoreDiv.innerHTML = '<i class="fa-solid fa-angles-up fa-beat-fade" style="font-size:16px;">点击折叠</i>';
    ...
    init : function(args){
        try {
            this.initCodeBlockOverflowY(336,'auto');// unit px 
        }catch (error) {
